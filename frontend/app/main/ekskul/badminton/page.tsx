...
export default function BadmintonPage() {
  return (
    <main className="bg-white min-h-screen">
      ...
      <PageBreadcrumb items={[{ label: "Home", href: "/" }, { label: "Ekskul", href: "/main/ekskul" }, { label: "Badminton" }]} />
        ...
        <RevealOnScroll as="section" direction="up" className="text-gray-700">
          ...
          <RevealOnScroll as="div" direction="up" delayClassName="delay-200">
            <p className="mb-4">
              ...
              berpengalaman yang siap membimbing para siswa, baik yang baru memulai maupun yang sudah memiliki dasar bermain.
            </p>
            <p className="mb-4">
              Latihan rutin diadakan setiap minggu, fokus pada pengembangan teknik dasar seperti pukulan, gerak kaki, dan strategi bermain. Selain itu, kami juga mengadakan pertandingan internal dan berpartisipasi dalam turnamen antar
              sekolah untuk mengasah kemampuan kompetitif dan mental juara para anggota.
            </p>
            <p>Bergabung dengan ekskul badminton tidak hanya meningkatkan kebugaran fisik, tetapi juga membangun karakter, sportivitas, dan kerja sama tim.</p>
          </RevealOnScroll>
        </RevealOnScroll>
      </div>
    </main>
